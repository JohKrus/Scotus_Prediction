#!/usr/bin/env python3
"""Run Term 2022-2023 predictions with scotus_v2 (2 replicates, agentic mode)."""
...
async def main():
    ...
    term_dir = config.pdf_dir_for_term(22)
    ...
    out_dir = config.results_dir() / "predictions" / "scotus_v2_final" / "term_22"
